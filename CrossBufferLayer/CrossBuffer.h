...
#define GetPixel(fb, x, y)                   (((Color*)fb.pBits)[x + (fb.Pitch >> 2) * y])
#define SetPixel(fb, x, y, color)            (((Color*)fb.pBits)[x + (fb.Pitch >> 2) * y] = color)
#define GetPixelLB(fb, height, x, y)         (((Color*)fb.pBits)[x + (fb.Pitch >> 2) * (height-y)])
#define SetPixelLB(fb, height, x, y, color)  (((Color*)fb.pBits)[x + (fb.Pitch >> 2) * (height-y)] = color)
